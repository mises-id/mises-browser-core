...
#ifndef MISES_EXTENSIONS_SHELL_BROWSER_SHELL_DESKTOP_CONTROLLER_IOS_H_
#define MISES_EXTENSIONS_SHELL_BROWSER_SHELL_DESKTOP_CONTROLLER_IOS_H_
...
class ShellDesktopControllerIOS : public DesktopController {
 public:
  ShellDesktopControllerIOS();

  ShellDesktopControllerIOS(const ShellDesktopControllerIOS&) = delete;
  ShellDesktopControllerIOS& operator=(const ShellDesktopControllerIOS&) =
      delete;

  ~ShellDesktopControllerIOS() override;
