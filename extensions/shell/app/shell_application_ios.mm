...
#import "mises/extensions/shell/app/shell_application_ios.h"
...
static std::unique_ptr<extensions::ShellMainDelegate> g_main_delegate;

@interface ExtensionShellAppSceneDelegate : UIResponder <UIWindowSceneDelegate>
@end

@implementation ExtensionShellAppSceneDelegate
...
@implementation ExtensionShellAppDelegate
...
- (UISceneConfiguration*)application:(UIApplication*)application
  ...
  configuration.delegateClass = ExtensionShellAppDelegate.class;
  return configuration;
}

- (BOOL)application:(UIApplication*)application
    willFinishLaunchingWithOptions:(NSDictionary*)launchOptions {
  g_main_delegate = std::make_unique<extensions::ShellMainDelegate>();
...
int RunExtensionShellApplication(int argc, const char** argv) {
  g_argc = argc;
  g_argv = argv;
  @autoreleasepool {
    return UIApplicationMain(argc, const_cast<char**>(argv), nil,
                             NSStringFromClass([ExtensionShellAppDelegate class]));
  }
}