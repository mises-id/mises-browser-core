#ifndef UI_VIEWS_CONTROLS_NATIVE_NATIVE_VIEW_HOST_ANDROID_H_
#define UI_VIEWS_CONTROLS_NATIVE_NATIVE_VIEW_HOST_ANDROID_H_
...
class NativeViewHostAndroid : public NativeViewHostWrapper {
 ...
 public:
  ...
  NativeViewHostAndroid(const NativeViewHostAndroid&) = delete;
    NativeViewHostAndroid& operator=(const NativeViewHostAndroid&) = delete;
