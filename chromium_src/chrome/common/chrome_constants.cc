...
#if BUILDFLAG(IS_MAC)
#define PRODUCT_STRING MISES_PRODUCT_STRING
...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("mises");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("mises");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("mises");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("mises");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("mises");
#endif  // OS_*
