...
#ifndef MISES_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_CHROME_PERMISSIONS_CLIENT_H_
#define MISES_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_CHROME_PERMISSIONS_CLIENT_H_

#include "components/permissions/permissions_client.h"

#define CanBypassEmbeddingOriginCheck                                    \
  MisesCanBypassEmbeddingOriginCheck(const GURL& requesting_origin,      \
