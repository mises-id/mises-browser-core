...
#ifndef MISES_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_PERMISSION_MANAGER_FACTORY_H_
#define MISES_CHROMIUM_SRC_CHROME_BROWSER_PERMISSIONS_PERMISSION_MANAGER_FACTORY_H_
...
#define BuildServiceInstanceForBrowserContext                                          \
  BuildServiceInstanceForBrowserContext_ChromiumImpl(content::BrowserContext* profile) \
      const;                                                             \
