...
#ifndef MISES_CHROMIUM_SRC_CHROME_BROWSER_BROWSER_PROCESS_IMPL_H_
#define MISES_CHROMIUM_SRC_CHROME_BROWSER_BROWSER_PROCESS_IMPL_H_
...
#endif  // MISES_CHROMIUM_SRC_CHROME_BROWSER_BROWSER_PROCESS_IMPL_H_
