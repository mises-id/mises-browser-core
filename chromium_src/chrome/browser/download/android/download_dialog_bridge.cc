...
#define Java_DownloadDialogBridge_showDialog(A1,A2,A3,A4,A5,A6,A7,A8) \
  Java_DownloadDialogBridge_showDialog(A1,A2,A3,A4,A5,A6,A7,A8,base::android::ConvertUTF8ToJavaString(env, url_to_download_))
