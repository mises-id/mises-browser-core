...
#include "mises/browser/ui/views/dialog_footnote_utils.h"
...
#include "mises/browser/widevine/widevine_permission_request.h"
#endif
...
#define MISES_PERMISSION_PROMPT_BUBBLE_BASE_VIEW                         \
...
#undef MISES_PERMISSION_PROMPT_BUBBLE_BASE_VIEW
