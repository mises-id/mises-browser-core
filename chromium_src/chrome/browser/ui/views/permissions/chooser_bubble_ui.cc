...
bool IsMisesPanel(content::WebContents* content) {
...
namespace views {
class MisesBubbleDialogDelegateView : public views::BubbleDialogDelegateView {
 public:
  MisesBubbleDialogDelegateView() : BubbleDialogDelegateView() {}
...
#define GetActiveWebContents                           \
  GetActiveWebContents() && !IsMisesPanel(contents) && \
      browser->tab_strip_model()->GetActiveWebContents

#define BubbleDialogDelegateView MisesBubbleDialogDelegateView
