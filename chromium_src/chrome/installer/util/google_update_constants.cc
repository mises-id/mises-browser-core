...
const wchar_t kGoogleUpdateSetupExe[] = L"MisesUpdateSetup.exe";
const wchar_t kRegPathClients[] = L"Software\\MisesSoftware\\Update\\Clients";
const wchar_t kRegPathClientState[] =
    L"Software\\MisesSoftware\\Update\\ClientState";
const wchar_t kRegPathClientStateMedium[] =
    L"Software\\MisesSoftware\\Update\\ClientStateMedium";
const wchar_t kRegPathGoogleUpdate[] = L"Software\\MisesSoftware\\Update";
