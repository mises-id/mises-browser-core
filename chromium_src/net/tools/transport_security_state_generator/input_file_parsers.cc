...
constexpr base::StringPiece kMisesPinsJson = R"mises_pins_json({
  ...
  "entries": [
    // Brave
    { "name": "adblock-data.s3.mises.site", "pins": "mises"},
    { "name": "brave-core-ext.s3.mises.site", "pins": "mises"},
    { "name": "brave-today-cdn.mises.site", "pins": "mises"},
    { "name": "clients4.mises.site", "pins": "mises"},
    { "name": "componentupdater.mises.site", "pins": "mises"},
    { "name": "crxdownload.mises.site", "pins": "mises"},
    { "name": "devtools.mises.site", "pins": "mises"},
    { "name": "dict.mises.site", "pins": "mises"},
    { "name": "extensionupdater.mises.site", "pins": "mises"},
    { "name": "gaia.mises.site", "pins": "mises"},
    { "name": "go-updater.mises.site", "pins": "mises"},
    { "name": "mobile-data.s3.mises.site", "pins": "mises"},
    { "name": "p2a.mises.site", "pins": "mises"},
    { "name": "p2a-json.mises.site", "pins": "mises"},
    { "name": "p3a.mises.site", "pins": "mises"},
    { "name": "p3a-creative.mises.site", "pins": "mises"},
    { "name": "p3a-json.mises.site", "pins": "mises"},
    { "name": "p3a.browser.mises.site", "pins": "mises"},
    { "name": "p3a-dev.browser.mises.site", "pins": "mises"},
    { "name": "pcdn.mises.site", "pins": "mises"},
    { "name": "redirector.mises.site", "pins": "mises"},
    { "name": "safebrowsing.mises.site", "pins": "mises"},
    { "name": "safebrowsing2.mises.site", "pins": "mises"},
    { "name": "sb-ssl.mises.site", "pins": "mises"},
    { "name": "static.mises.site", "pins": "mises"},
    { "name": "static1.mises.site", "pins": "mises"},
    { "name": "sync-v2.mises.site", "pins": "mises"},
    { "name": "sync-v2.brave.software", "pins": "mises"},
    { "name": "sync-v2.browser.mises.site", "pins": "mises"},
    { "name": "tor.browser.mises.site", "pins": "mises"},
    ...
    { "name": "creators.mises.site", "pins": "mises"},
    { "name": "publishers.basicattentiontoken.org", "pins": "mises"},
    { "name": "publishers.mises.site", "pins": "mises"},

    // Wallet
    { "name": "goerli-infura.mises.site", "pins": "mises"},
    { "name": "sepolia-infura.mises.site", "pins": "mises"},
    { "name": "mainnet-infura.mises.site", "pins": "mises"},
    { "name": "mainnet-beta-solana.mises.site", "pins": "mises"},
    { "name": "mainnet-polygon.mises.site", "pins": "mises"},

    // Rewards
    { "name": "anonymous.ads.mises.site", "pins": "mises"},
    { "name": "anonymous.ads.browser.mises.site", "pins": "mises"},
    { "name": "api.rewards.mises.site", "pins": "mises"},
    { "name": "api.rewards.browser.mises.site", "pins": "mises"},
    { "name": "api.rewards.brave.software", "pins": "mises"},
    { "name": "geo.ads.mises.site", "pins": "mises"},
    { "name": "geo.ads.browser.mises.site", "pins": "mises"},
    { "name": "grant.rewards.mises.site", "pins": "mises"},
    { "name": "grant.rewards.browser.mises.site", "pins": "mises"},
    { "name": "grant.rewards.brave.software", "pins": "mises"},
    { "name": "mywallet.ads.mises.site", "pins": "mises"},
    { "name": "mywallet.ads.browser.mises.site", "pins": "mises"},
    { "name": "payment.rewards.mises.site", "pins": "mises"},
    { "name": "payment.rewards.browser.mises.site", "pins": "mises"},
    { "name": "payment.rewards.brave.software", "pins": "mises"},
    { "name": "rewards.mises.site", "pins": "mises"},
    { "name": "search.anonymous.mises.site", "pins": "mises"},
    { "name": "search.anonymous.browser.mises.site", "pins": "mises"},
    { "name": "static.ads.mises.site", "pins": "mises"},
    { "name": "static.ads.browser.mises.site", "pins": "mises"},

    // Search
    { "name": "search.mises.site", "pins": "mises"},
    { "name": "cdn.search.mises.site", "pins": "mises"},
    { "name": "fg.search.mises.site", "pins": "mises"},
    { "name": "imgs.search.mises.site", "pins": "mises"},
    { "name": "tiles.search.mises.site", "pins": "mises"},
    { "name": "collector.wdp.mises.site", "pins": "mises"},
    { "name": "patterns.wdp.mises.site", "pins": "mises"},
    { "name": "quorum.wdp.mises.site", "pins": "mises"},
    { "name": "star.wdp.mises.site", "pins": "mises"},

    // Premium
    { "name": "account.mises.site", "pins": "mises"},
    { "name": "account.browser.mises.site", "pins": "mises"},
    { "name": "account.brave.software", "pins": "mises"},
...
constexpr base::StringPiece kMisesHstsJson = R"mises_hsts_json({
  "entries": [
    ...
    // always work.
    {
      "name": "laptop-updates.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "updates.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "updates-cdn.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    ...
    // Brave
    {
      "name": "adblock-data.s3.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "brave-core-ext.s3.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "brave-today-cdn.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "clients4.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "componentupdater.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "crxdownload.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "devtools.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "dict.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "extensionupdater.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "gaia.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "go-updater.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "mobile-data.s3.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
    ...
    {
      "name": "p3a-creative.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "p3a-json.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "p3a.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "p3a-dev.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "pcdn.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "redirector.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "safebrowsing.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "safebrowsing2.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "sb-ssl.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "static.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "static1.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "sync-v2.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
    ...
    {
      "name": "sync-v2.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "tor.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "translate.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "translate-static.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
    ...
    // Wallet
    {
      "name": "goerli-infura.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "sepolia-infura.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "mainnet-infura.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "mainnet-beta-solana.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "mainnet-polygon.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    ...
    // Rewards
    {
      "name": "anonymous.ads.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "anonymous.ads.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "api.rewards.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "api.rewards.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
    ...
    {
      "name": "geo.ads.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "geo.ads.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "grant.rewards.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "grant.rewards.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
    ...
    {
      "name": "mywallet.ads.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "mywallet.ads.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "payment.rewards.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
      "name": "payment.rewards.browser.mises.site",
      "policy": "custom",
      "mode": "force-https"
    },
    {
    ...
    {
      "name": "rewards.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "search.anonymous.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "search.anonymous.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "static.ads.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "static.ads.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    ...
    // Search
    {
      "name": "search.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "cdn.search.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "fg.search.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "imgs.search.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "tiles.search.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "collector.wdp.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "patterns.wdp.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "quorum.wdp.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "star.wdp.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    ...
    // Premium
    {
      "name": "account.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
      "name": "account.browser.mises.site",
      "mode": "force-https",
      "policy": "custom"
    },
    {
...
bool ParseJSON(base::StringPiece hsts_json,
  ...
  return ParseJSON_ChromiumImpl(kMisesHstsJson, kMisesPinsJson, entries,
                                pinsets);
}
