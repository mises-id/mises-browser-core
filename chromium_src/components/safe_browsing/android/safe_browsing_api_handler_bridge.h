...
#ifndef MISES_COMPONENTS_SAFE_BROWSING_ANDROID_SAFE_BROWSING_API_HANDLER_BRIDGE_H_
#define MISES_COMPONENTS_SAFE_BROWSING_ANDROID_SAFE_BROWSING_API_HANDLER_BRIDGE_H_
...
class SafeBrowsingApiHandlerBridge {
 public:
  ...
  void StartURLCheck(scoped_refptr<network::SharedURLLoaderFactory> url_loader_factory,std::unique_ptr<ResponseCallback> callback,
                     const GURL& url,
                     const SBThreatTypeSet& threat_types);
  void StartMisesCheck(std::unique_ptr<SafeBrowsingApiHandlerBridge::ResponseCallback> callback,const GURL& url);

  void OnMisesURLLoadComplete(const network::SimpleURLLoader* source,
...
#endif  // MISES_COMPONENTS_SAFE_BROWSING_ANDROID_SAFE_BROWSING_API_HANDLER_BRIDGE_H_
