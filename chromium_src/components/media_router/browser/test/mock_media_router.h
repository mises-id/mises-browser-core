#ifndef MISES_COMPONENTS_MEDIA_ROUTER_BROWSER_ANDROID_MEDIA_ROUTER_MOCK_H_
#define MISES_COMPONENTS_MEDIA_ROUTER_BROWSER_ANDROID_MEDIA_ROUTER_MOCK_H_
...
#include "src/components/media_router/browser/test/mock_media_router.h"
#undef Initialize
