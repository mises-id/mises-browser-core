...
using PermissionContextBase_MisesImpl = PermissionContextBase;
...
#define MISES_PERMISSION_CONTEXT_BASE_H_              \
  friend PermissionContextBase_MisesImpl;             \
                                                      \
 protected:                                           \
...
#undef MISES_PERMISSION_CONTEXT_BASE_H_
