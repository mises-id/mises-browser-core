...
inline constexpr char kDefaultSearchProviderByExtension[] =
    "mises.default_search_provider_by_extension";
inline constexpr char kAddOpenSearchEngines[] =
    "mises.other_search_engines_enabled";
inline constexpr char kMisesDefaultSearchVersion[] =
    "mises.search.default_version";
inline constexpr char kSyncedDefaultPrivateSearchProviderGUID[] =
    "mises.default_private_search_provider_guid";
inline constexpr char kSyncedDefaultPrivateSearchProviderData[] =
    "mises.default_private_search_provider_data";
