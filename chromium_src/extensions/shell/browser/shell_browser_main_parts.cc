...
int ShellBrowserMainParts::PreMainMessageLoopRun() {
  ...
  content::Shell::Initialize(std::make_unique<content::ShellPlatformDelegate>());
  net::NetModule::SetResourceProvider(PlatformResourceProvider);
  content::Shell::CreateNewWindow(browser_context_.get(), GURL(), nullptr,
                         gfx::Size());
...
void ShellBrowserMainParts::WillRunMainMessageLoop(
  ...
  content::BrowserMainParts::WillRunMainMessageLoop(run_loop);
}
