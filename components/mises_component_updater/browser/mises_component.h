...
class MisesComponent {
 public:
  ...
  explicit MisesComponent(Delegate* delegate);
  MisesComponent(const MisesComponent&) = delete;
  MisesComponent& operator=(const MisesComponent&) = delete;
  virtual ~MisesComponent();
