...
#include "mises/components/ipfs/ipfs_dns_resolver.h"
...
class IpfsService : public KeyedService,
                    public MisesIpfsClientUpdater::Observer {
 public:
 ...
 private:
  ...
  // MisesIpfsClientUpdater::Observer
  ...
  raw_ptr<MisesIpfsClientUpdater> ipfs_client_updater_ = nullptr;
