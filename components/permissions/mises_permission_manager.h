...
class MisesPermissionManager : public PermissionManager {
 public:
  MisesPermissionManager(content::BrowserContext* browser_context,
                         PermissionContextMap permission_contexts);
  ~MisesPermissionManager() override = default;

  MisesPermissionManager(const MisesPermissionManager&) = delete;
  MisesPermissionManager& operator=(const MisesPermissionManager&) = delete;
