...
#include "mises/components/services/ipfs/ipfs_service_impl.h"
...
#include "mises/components/services/ipfs/ipfs_service_utils.h"
...
void IpfsServiceImpl::Launch(mojom::IpfsConfigPtr config,
  ...
  child_monitor_ = std::make_unique<mises::ChildProcessMonitor>();
