...
class ObservableQueryDelegationsInner extends chain_query_1.ObservableChainQuery {
    ...
    *fetch() {
        ...
        (_a = this.QueryClient) === null || _a === void 0 ? void 0 : _a.fetchQuery("delegations", () => __awaiter(this, void 0, void 0, function* () {
            const res = yield this.misesStore.delegations(this.bech32Address);
            this.setResponse({
                data: res,
                status: 200,
                staled: true,
...
class ObservableQueryUnbondingDelegationsInner extends chain_query_1.ObservableChainQuery {
    ...
    *fetch() {
        ...
        (_a = this.QueryClient) === null || _a === void 0 ? void 0 : _a.fetchQuery("unbondingDelegations", () => __awaiter(this, void 0, void 0, function* () {
            const res = yield this.misesStore.unbondingDelegations(this.bech32Address);
            this.setResponse({
                data: res,
                status: 200,
                staled: true,
...
class MisesStore {
    ...
    getBalanceUMIS() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.requester.sendMessage(router_1.BACKGROUND_PORT, new background_1.BalanceUMISMsg());
        });
    }
