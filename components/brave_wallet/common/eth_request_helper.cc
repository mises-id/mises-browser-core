...
#include "mises/components/brave_wallet/common/json_rpc_requests.h"
...
absl::optional<base::Value::Dict> GetObjectFromParamsList(const std::string& json) {
