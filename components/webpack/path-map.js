...
module.exports = function (genPath) {
  return {
    ...
    'chrome://resources/mises/fonts' : path.join(
                                        process.env.ROOT_GEN_DIR,
                                        'mises/ui/webui/resources/fonts'),
    'chrome://resources/mises' : path.join(
                                  process.env.ROOT_GEN_DIR,
                                  'mises/ui/webui/resources/tsc'),
    ...
    'react-native': path.resolve(
      __dirname, '../../node_modules/react-native-web'),
  }
}
