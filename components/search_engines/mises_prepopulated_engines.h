...
extern const int kMisesCurrentDataVersion;
extern const int kMisesFirstTrackedDataVersion;
...
enum MisesPrepopulatedEngineID : unsigned int {
...
extern const PrepopulatedEngine mises_duckduckgo;
...
#endif
extern const PrepopulatedEngine mises_ecosia;
extern const PrepopulatedEngine mises_qwant;
extern const PrepopulatedEngine startpage;
extern const PrepopulatedEngine mises_yandex;
extern const PrepopulatedEngine mises_search;
extern const PrepopulatedEngine mises_search_tor;
extern const PrepopulatedEngine mises_bing;
