...
class MisesProxyingURLLoaderFactory
    : public network::mojom::URLLoaderFactory {
 public:
  using DisconnectCallback =
      base::OnceCallback<void(MisesProxyingURLLoaderFactory*)>;
  ...
  MisesProxyingURLLoaderFactory& operator=(
      const MisesProxyingURLLoaderFactory&) = delete;
 ...
 private:
  friend class base::DeleteHelper<MisesProxyingURLLoaderFactory>;
  friend class base::RefCountedDeleteOnSequence<MisesProxyingURLLoaderFactory>;
