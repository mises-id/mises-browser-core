...
MisesProxyingURLLoaderFactory::InProgressRequest::FollowRedirectParams::
...
MisesProxyingURLLoaderFactory::InProgressRequest::InProgressRequest(
  ...
  target_client_.set_disconnect_handler(base::BindOnce(
      &MisesProxyingURLLoaderFactory::InProgressRequest::OnRequestError,
...
void MisesProxyingURLLoaderFactory::InProgressRequest::Restart() {
  UpdateRequestInfo();
  RestartInternal();
}

void MisesProxyingURLLoaderFactory::InProgressRequest::UpdateRequestInfo() {
  // TODO(iefremov): Update |ctx_| here and get rid of multiple spots where
  // it is refilled.
}

void MisesProxyingURLLoaderFactory::InProgressRequest::RestartInternal() {
  ...
  base::RepeatingCallback<void(int)> continuation =
      base::BindRepeating(&InProgressRequest::ContinueToBeforeSendHeaders,
                          weak_factory_.GetWeakPtr());
  redirect_url_ = GURL();
  ctx_ = mises::MisesRequestInfo::MakeCTX(request_, render_process_id_,
...
void MisesProxyingURLLoaderFactory::InProgressRequest::FollowRedirect(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::SetPriority(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::OnReceiveEarlyHints(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::OnReceiveRedirect(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::OnUploadProgress(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::OnTransferSizeUpdated(
    int32_t transfer_size_diff) {
  target_client_->OnTransferSizeUpdated(transfer_size_diff);
}

void MisesProxyingURLLoaderFactory::InProgressRequest::OnComplete(
...
void MisesProxyingURLLoaderFactory::InProgressRequest::
  ...
  if (ctx_->blocked_by != mises::kNotBlocked) {
...
void MisesProxyingURLLoaderFactory::InProgressRequest::ContinueToStartRequest(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void MisesProxyingURLLoaderFactory::InProgressRequest::ContinueToSendHeaders(
    int error_code) {
  if (error_code != net::OK) {
    OnRequestError(network::URLLoaderCompletionStatus(error_code));
    return;
...
void MisesProxyingURLLoaderFactory::InProgressRequest::OnRequestError(
    const network::URLLoaderCompletionStatus& status) {
...
void MisesProxyingURLLoaderFactory::Clone(
    mojo::PendingReceiver<network::mojom::URLLoaderFactory> loader_receiver) {
  proxy_receivers_.Add(this, std::move(loader_receiver));
}

void MisesProxyingURLLoaderFactory::OnTargetFactoryError() {
...
void MisesProxyingURLLoaderFactory::OnProxyBindingError() {
...
void MisesProxyingURLLoaderFactory::RemoveRequest(InProgressRequest* request) {
...
void MisesProxyingURLLoaderFactory::MaybeRemoveProxy() {
