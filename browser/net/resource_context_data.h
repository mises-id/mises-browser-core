...
class ResourceContextData : public base::SupportsUserData::Data {
 public:
  ...
  void RemoveProxyWebSocket(MisesProxyingWebSocket* proxy);
 ...
 private:
  ...
  std::set<std::unique_ptr<MisesProxyingURLLoaderFactory>,
           base::UniquePtrComparator>
      proxies_;

  std::set<std::unique_ptr<MisesProxyingWebSocket>,
           base::UniquePtrComparator>
      websocket_proxies_;
