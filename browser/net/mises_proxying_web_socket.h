...
class MisesProxyingWebSocket
 ...
 public:
  ...
  using DisconnectCallback =
      base::OnceCallback<void(MisesProxyingWebSocket*)>;

  MisesProxyingWebSocket(
  ...
  ~MisesProxyingWebSocket() override;

  static MisesProxyingWebSocket* ProxyWebSocket(
 ...
 private:
  ...
  base::WeakPtrFactory<MisesProxyingWebSocket> weak_factory_{this};
};
