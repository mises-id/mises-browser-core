...
MisesIconWithBadgeImageSource::MisesIconWithBadgeImageSource(
    const gfx::Size& size,
...
// static
gfx::Size MisesIconWithBadgeImageSource::GetMaxBadgeSize() {
  return gfx::Size(kBadgeMaxWidth, kBadgeHeight);
}

void MisesIconWithBadgeImageSource::SetAllowEmptyText(bool v) {
  allow_empty_text_ = v;
}

void MisesIconWithBadgeImageSource::PaintBadge(gfx::Canvas* canvas) {
  if (!badge_) {
    return;
  }
...
void MisesIconWithBadgeImageSource::PaintBadgeWithText(gfx::Canvas* canvas) {
...
void MisesIconWithBadgeImageSource::PaintBadgeWithoutText(
...
gfx::Rect MisesIconWithBadgeImageSource::GetBadgeRect(
...
gfx::Rect MisesIconWithBadgeImageSource::GetIconAreaRect() const {
