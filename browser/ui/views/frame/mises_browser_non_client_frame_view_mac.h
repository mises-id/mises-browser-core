...
class MisesWindowFrameGraphic;

class MisesBrowserNonClientFrameViewMac : public BrowserNonClientFrameViewMac {
 public:
  MisesBrowserNonClientFrameViewMac(BrowserFrame* frame,
                                    BrowserView* browser_view);
  ~MisesBrowserNonClientFrameViewMac() override;

  MisesBrowserNonClientFrameViewMac(
      const MisesBrowserNonClientFrameViewMac&) = delete;
  MisesBrowserNonClientFrameViewMac& operator=(
      const MisesBrowserNonClientFrameViewMac&) = delete;
 ...
 private:
  ...
  //std::unique_ptr<MisesWindowFrameGraphic> frame_graphic_;
