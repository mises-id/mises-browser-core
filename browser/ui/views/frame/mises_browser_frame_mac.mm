...
#include "mises/browser/ui/views/frame/mises_browser_frame_mac.h"

//#include "mises/browser/ui/views/tabs/features.h"
#include "chrome/browser/ui/views/frame/browser_view.h"
#include "chrome/browser/ui/views/toolbar/toolbar_view.h"

MisesBrowserFrameMac::MisesBrowserFrameMac(BrowserFrame* browser_frame,
                                           BrowserView* browser_view)
    : BrowserFrameMac(browser_frame, browser_view),
      browser_(browser_view->browser()),
      browser_view_(browser_view) {}

MisesBrowserFrameMac::~MisesBrowserFrameMac() = default;

void MisesBrowserFrameMac::GetWindowFrameTitlebarHeight(
