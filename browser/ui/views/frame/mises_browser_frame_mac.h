...
class MisesBrowserFrameMac : public BrowserFrameMac {
 public:
  MisesBrowserFrameMac(BrowserFrame* browser_frame, BrowserView* browser_view);
  ~MisesBrowserFrameMac() override;
