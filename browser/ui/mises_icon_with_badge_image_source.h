...
class MisesIconWithBadgeImageSource : public IconWithBadgeImageSource {
 public:
  MisesIconWithBadgeImageSource(
      const gfx::Size& size,
      GetColorProviderCallback get_color_provider_callback,
      size_t content_image_size,
      size_t image_left_margin_extra);

  MisesIconWithBadgeImageSource(const MisesIconWithBadgeImageSource&) = delete;
  MisesIconWithBadgeImageSource& operator=(
      const MisesIconWithBadgeImageSource&) = delete;
