...
class MisesRendererUpdater : public KeyedService {
 public:
  MisesRendererUpdater(Profile* profile,
                       brave_wallet::KeyringService* keyring_service,
                       PrefService* local_state);
  MisesRendererUpdater(const MisesRendererUpdater&) = delete;
  MisesRendererUpdater& operator=(const MisesRendererUpdater&) = delete;
  ~MisesRendererUpdater() override;
