...
#ifndef MISES_BROWSER_BRAVE_SHELL_INTEGRATION_MAC_H_
#define MISES_BROWSER_BRAVE_SHELL_INTEGRATION_MAC_H_
...
#endif  // MISES_BROWSER_BRAVE_SHELL_INTEGRATION_MAC_H_
