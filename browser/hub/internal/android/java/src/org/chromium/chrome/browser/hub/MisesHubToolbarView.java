...
/**
 * Mises's extension for {@link HubToolbarView}. Here we control what elements should be visible in
 * tab switcher mode when bottom toolbar is visible.
 */
public class MisesHubToolbarView extends HubToolbarView {
    private static final String TAG = "MisesHubToolbarView";

    private Button mActionButton;
    private FrameLayout mMenuButton;

    public MisesHubToolbarView(Context context, AttributeSet attributeSet) {
    ...
    private void updateButtonsVisibility() {
        boolean isMenuFromBottom =
                ContextUtils.getAppSharedPreferences()
                        .getBoolean(MisesPreferenceKeys.MISES_IS_MENU_FROM_BOTTOM, true);
