...
/**
 * Mises's extension of {@link HubManagerImpl}. We need it to adjust bottom margin for the bottom
 * toolbar, when it is visible.
 */
public class MisesHubManagerImpl extends HubManagerImpl {
