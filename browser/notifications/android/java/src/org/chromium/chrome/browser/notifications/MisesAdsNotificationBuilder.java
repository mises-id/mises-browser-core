 ...
 */
public class MisesAdsNotificationBuilder extends NotificationBuilderBase {
    /**
    ...
    public MisesAdsNotificationBuilder(Context context) {
    ...
    public NotificationBuilderBase setChannelId(String channelId) {
        return super.setChannelId(MisesChannelDefinitions.ChannelId.BRAVE_ADS);
    }
    ...
    public NotificationWrapper build(NotificationMetadata metadata) {
        ...
        setChannelId(MisesChannelDefinitions.ChannelId.BRAVE_ADS);
        ...
        String channelId = (ApplicationStatus.hasVisibleActivities())
                ? MisesChannelDefinitions.ChannelId.BRAVE_ADS
                : MisesChannelDefinitions.ChannelId.BRAVE_ADS_BACKGROUND;
