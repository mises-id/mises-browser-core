...
class MisesCommandLineHelper {
 public:
  explicit MisesCommandLineHelper(base::CommandLine* command_line);
  MisesCommandLineHelper(const MisesCommandLineHelper&) = delete;
  MisesCommandLineHelper& operator=(const MisesCommandLineHelper&) = delete;
  inline ~MisesCommandLineHelper() = default;
