...
base::FilePath GetResourcesPakFilePath() {
  ...
  pak_path = pak_path.AppendASCII("mises_resources.pak");
  return pak_path;
#endif  // OS_MAC
}
#endif  // OS_ANDROID
...
#if BUILDFLAG(IS_ANDROID)
  ui::MisesLoadMainAndroidPackFile("assets/mises_resources.pak",
                                   base::FilePath());
  ui::MisesLoadMises100PercentPackFile("assets/mises_100_percent.pak",
                                       base::FilePath());
#else
