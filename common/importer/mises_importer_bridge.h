...
#ifndef MISES_COMMON_IMPORTER_BRAVE_IMPORTER_BRIDGE_H_
#define MISES_COMMON_IMPORTER_BRAVE_IMPORTER_BRIDGE_H_

#include <string>

class MisesImporterBridge {
 public:
...
#endif  // MISES_COMMON_IMPORTER_BRAVE_IMPORTER_BRIDGE_H_
