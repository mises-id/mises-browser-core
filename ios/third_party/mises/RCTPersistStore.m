...
static NSString *const RCTStorageDirectory = @"persistStore";
static NSString *const RCTManifestFileName = @"persist-root";
static const NSUInteger RCTInlineValueThreshold = 10240;
...
#pragma mark - RCTPersistStore

@implementation RCTPersistStore
{
  BOOL _haveSetup;
