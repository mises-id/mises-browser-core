...
#include "mises/ios/browser/api/bookmarks/importer/brave_bookmarks_importer.h"
...
#include "mises/ios/browser/api/bookmarks/importer/bookmark_html_reader.h"
#include "mises/ios/browser/api/bookmarks/importer/bookmarks_importer.h"
#include "mises/ios/browser/api/bookmarks/importer/imported_bookmark_entry.h"
...
- (instancetype)initFromChromiumImportedBookmark:
  ...
  if ((self = [super init])) {
    ...
    _creationTime =
        [NSDate dateWithTimeIntervalSince1970:entry.creation_time.InSecondsFSinceUnixEpoch()];
  }
  return self;
}
...
- (ImportedBookmarkEntry)toChromiumImportedBookmark {
  ...
  entry.creation_time =
      base::Time::FromSecondsSinceUnixEpoch([self.creationTime timeIntervalSince1970]);
