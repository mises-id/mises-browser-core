...
void BookmarkFaviconFetcher::ExportBookmarks() {
  ExtractUrls(ios::LocalOrSyncableBookmarkModelFactory::GetForBrowserState(browser_state_)
                  ->bookmark_bar_node());
  ExtractUrls(ios::LocalOrSyncableBookmarkModelFactory::GetForBrowserState(browser_state_)
                  ->other_node());
  ExtractUrls(ios::LocalOrSyncableBookmarkModelFactory::GetForBrowserState(browser_state_)
  ...
  base::ThreadPool::PostTask(
      ...
      base::BindOnce(
          ...
          base::MakeRefCounted<Writer>(
              codec.Encode(
                  ios::LocalOrSyncableBookmarkModelFactory::GetForBrowserState(browser_state_),
