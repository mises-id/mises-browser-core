...
const misesAndroidTabUiStringsPath = path.resolve(path.join(srcDir, 'mises', 'android', 'features', 'tab_ui', 'java', 'strings', 'android_chrome_tab_ui_strings.grd'))
...
function getAutoGeneratedGrdMappings() {
  if (typeof(getAutoGeneratedGrdMappings.mappings) === 'undefined') {
    ...
    getAutoGeneratedGrdMappings.mappings = {
      ...
      ...addGrd(androidTabUiStringsPath, misesAndroidTabUiStringsPath),
    }
