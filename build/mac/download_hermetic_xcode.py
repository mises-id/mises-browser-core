...
def InstallXcodeBinaries():
    ...
    # only download for Mises goma users
    goma_server_host = os.environ.get('npm_config_goma_server_host')
    if goma_server_host is None or not goma_server_host.endswith('.mises.com'):
        print("Goma server host is not configured for Mises")
        return 0
