...
import org.chromium.chrome.browser.toolbar.top.MisesToolbarLayoutImpl;
...
public class MisesMenuButtonCoordinator extends MenuButtonCoordinator {
    ...
    private void updateMenuButtonState() {
        MisesToolbarLayoutImpl layout =
                (MisesToolbarLayoutImpl) mActivity.findViewById(R.id.toolbar);
        assert layout != null;
        if (layout != null) {
    ...
    public static void setMenuFromBottom(boolean isMenuFromBottom) {
        ContextUtils.getAppSharedPreferences()
                .edit()
                .putBoolean(MisesPreferenceKeys.MISES_IS_MENU_FROM_BOTTOM, isMenuFromBottom)
                .apply();
    }
