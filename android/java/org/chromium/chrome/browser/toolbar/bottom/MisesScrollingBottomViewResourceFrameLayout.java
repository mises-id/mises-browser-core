...
public class MisesScrollingBottomViewResourceFrameLayout
    ...
    public MisesScrollingBottomViewResourceFrameLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setBottomControlsCoordinatorSupplier(
        ...
        MisesBottomControlsCoordinator().getBottomToolbarVisibleSupplier().addObserver(
        ...
        MisesBottomControlsCoordinator().getTabGroupUiVisibleSupplier().addObserver(
                mCallbackController.makeCancelable((visible) -> {
                    // Only make changes if visibility changed.
    ...
    private MisesBottomControlsCoordinator MisesBottomControlsCoordinator() {
        if (mBottomControlsCoordinatorSupplier != null
                && mBottomControlsCoordinatorSupplier.get()
                                instanceof MisesBottomControlsCoordinator) {
            return (MisesBottomControlsCoordinator) mBottomControlsCoordinatorSupplier.get();
        }
        return null;
    }
