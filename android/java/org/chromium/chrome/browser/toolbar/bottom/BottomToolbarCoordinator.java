...
class BottomToolbarCoordinator implements View.OnLongClickListener {
    ...
    private final MisesScrollingBottomViewResourceFrameLayout mScrollingBottomView;
    ...
    BottomToolbarCoordinator(ScrollingBottomViewResourceFrameLayout scrollingBottomView, View root,
        ...
        mScrollingBottomView = (MisesScrollingBottomViewResourceFrameLayout) scrollingBottomView;
            ...
            final OnClickListener homeButtonListener =
                    v -> {
                        if (mHomepageManager.isHomepageEnabled()) {
                            try {
                                MisesActivity.getMisesActivity().setComesFromNewTab(true);
                            } catch (MisesActivity.MisesActivityNotFoundException e) {
