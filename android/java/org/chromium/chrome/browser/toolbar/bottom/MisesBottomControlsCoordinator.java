...
public class MisesBottomControlsCoordinator extends BottomControlsCoordinator {
    ...
    public MisesBottomControlsCoordinator(
    ...
    public void setBottomToolbarVisible(boolean visible) {
        if (mMediator instanceof MisesBottomControlsMediator) {
            ((MisesBottomControlsMediator) mMediator).setBottomToolbarVisible(visible);
        }
        if (mBottomToolbarCoordinator != null) {
    ...
    public ObservableSupplierImpl<Boolean> getBottomToolbarVisibleSupplier() {
        if (mMediator instanceof MisesBottomControlsMediator) {
            return ((MisesBottomControlsMediator) mMediator).getBottomToolbarVisibleSupplier();
        }
    ...
    public ObservableSupplierImpl<Boolean> getTabGroupUiVisibleSupplier() {
        if (mMediator instanceof MisesBottomControlsMediator) {
            return ((MisesBottomControlsMediator) mMediator).getTabGroupUiVisibleSupplier();
        }
        assert false : "Make sure mMediator is properly patched in bytecode.";
        return null;
    }
