...
public class MisesSearchEnginePreference extends SearchEngineSettings {
    ...
    public MisesSearchEnginePreference(boolean isPrivate) {
        mPrivate = isPrivate;
    }
    ...
    public void createAdapterIfNecessary() {
        ...
        mSearchEngineAdapter = new MisesSearchEngineAdapter(getActivity(), getProfile(mPrivate));
    }
