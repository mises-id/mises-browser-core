...
public class RadioButtonGroupUnstoppableDomainsResolveMethodPreference
    ...
    public RadioButtonGroupUnstoppableDomainsResolveMethodPreference(
            Context context, AttributeSet attrs) {
        super(context, attrs);
        setLayoutResource(
                R.layout.radio_button_group_unstoppable_domains_resolve_method_preference);
    ...
    public void onBindViewHolder(PreferenceViewHolder holder) {
        ...
        mGroup = (RadioButtonWithDescriptionLayout) holder.findViewById(
                R.id.unstoppable_domains_resolve_method_radio_group);
