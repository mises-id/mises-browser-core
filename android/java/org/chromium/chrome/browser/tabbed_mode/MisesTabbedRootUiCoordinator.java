...
public class MisesTabbedRootUiCoordinator extends TabbedRootUiCoordinator {
    private AppCompatActivity mActivity;
    private OneshotSupplier<HubManager> mHubManagerSupplier;

    public MisesTabbedRootUiCoordinator(
    ...
    public void onPostInflationStartup() {
        ...
        assert mActivity instanceof MisesActivity;

        if (mActivity instanceof MisesActivity) {
            ((MisesActivity) mActivity)
