...
public class MisesTabGroupUiCoordinator extends TabGroupUiCoordinator {
    ...
    public MisesTabGroupUiCoordinator(@NonNull Activity activity, @NonNull ViewGroup parentView,
        ...
        if (toolbarRightButton != null) {
            toolbarRightButton.setImageResource(R.drawable.mises_new_group_tab);
        }
    }
